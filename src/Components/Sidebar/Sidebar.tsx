...
export function SidebarItem({ text, icon, isActive = false }: sidebarItemsProps) {
    return (
        <div
            className={`group flex cursor-pointer items-center rounded-lg p-3 transition-all duration-200 ${
                isActive
